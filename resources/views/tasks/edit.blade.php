...
<div class="col-md-8 col-md-offset-2">
  	<div class="panel">
	{!! Form::open(['class'=>'form-horizontal', 'method'=>'patch', 'action'=>['TasksController@update',  $tasks->id]]) !!}
		...
		<div class="panel-body">
	  		<div class="form-group">
	    		...
	    		<div class="col-lg-8">
					...
					<span>{{$tasks->project->project_name}}</span>
					</div>
	    		</div>
	  		</div>
		...
		<div class="panel-body">
	  		<div class="form-group">
	    		...
	    		<div class="col-lg-8">
	    			<div class="bs-component">
					<input type="text" id="inputStandard" name="task_name" value="{{$tasks->task_name}}" class="form-control" placeholder="Type Here...">
					</div>
	    		</div>
	  		</div>
	  		...
	  		<div class="form-group">
	    		...
	    		<div class="col-lg-8">
	    			<div class="bs-component">
					<textarea class="form-control textarea-grow" name="task_description" id="textArea1" rows="4">{{$tasks->task_description}}</textarea>
					</div>
	    		</div>
	  		</div>
	  		...
	  		<div class="form-group">
	    		...
	    		<div class="col-lg-8">
					...
					<select type="" id="inputStandard" name="assigned_to" class="form-control" placeholder="">
						...
						<option value="{{$personnel->id}}" @if(!strcmp($tasks->assigned_to, $personnel->id)) selected @endif>{{$personnel->name}}</option>
						@endforeach
					</select>
					</div>
	    		</div>
	  		...
	  		<div class="form-group">
	    		...
	    		<div class="col-lg-8">
	    			<div class="bs-component">
					<input type="date" id="inputStandard" name="start_date" value="{{$tasks->start_date}}" class="form-control" placeholder="">
					</div>
	    		</div>
	  		</div>
	  		<br>
	  		...
	  		<div class="form-group">
	    		...
	    		<div class="col-lg-8">
	    			<div class="bs-component">
					<input type="date" id="inputStandard" name="end_date" value="{{$tasks->end_date}}" class="form-control" placeholder="">
					</div>
	    		</div>
	  		</div>

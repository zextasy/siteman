        ...
        <div class="right_col" role="main">  
          ...
          <div class="row tile_count">
            ...
            <div class="col-md-2 col-sm-4 col-xs-6 tile_stats_count">
              ...
              <span class="count_bottom"><i >{{ $reports->where('template_id', 1)->count() }}</i> approved</span>
              <span class="count_bottom"><i >{{ $reports->where('template_id', 2)->count() }}</i> rejected</span>
            </div> 
          </div>
          <!-- /top tiles -->
